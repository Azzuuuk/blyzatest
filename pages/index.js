...
const gamesData = [
  ...
  { href: '/games/pointpursuit', category: 'Brain Busters', tag: 'Brainy', icon: 'fa-brain', title: 'Point Pursuit', description: 'Ready for a brainy adventure? Dive into 5 exciting trivia categories, scale 5 levels of mind-bending questions, and pursue those points!', players: '2-4 Teams', time: '15-25 min' },
  { href: '/games/box-of-lies', category: 'Social & Deception', tag: 'Deception', icon: 'fa-box-open', title: 'Box of Lies', description: 'Deception or truth? Master the art of the perfect poker face as you bluff, trick, and laugh your way to victory!', players: '2 Teams', time: '5-15 min' },
