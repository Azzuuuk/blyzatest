...
const gamesData = [
  ...
  { href: '/games/game2', category: 'Social & Deception', tag: 'Deception', icon: 'fa-user-secret', title: 'Find The Imposter', description: 'Deception meets deduction! Get a question, give your answer, and try to blend in... or sniff out the one who doesn\'t quite fit.', players: '3-10 Players', time: '10-15 min' },
